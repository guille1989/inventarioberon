...
class SeguimientoInsumos extends Component {
    ...
    openDialogPDF(props){
        console.log(props.materiaPrima)

        this.setState({
            materiaPrimaAux: props.materiaPrima
        })
    }

    pdfMateriaPrima(props){
        let loc = { width: '24px', height: '24px' };
        let flagAux = PdfMP;       
        
        return (
            <div> 
                <a href="#" className="pe-auto" onClick={() =>  this.setState({ 
                    hideDialogPdf: true, 
                    materiaPrimaAux: props.materiaPrima,
                    fechaEntradaAux: props.fechaEntrada.split('T')[0],
                    fechaVencimientoAux: props.fechaVencimiento.split(',').pop(),
                    pesoBultoAux: props.pesoBulto,
                    bultosEstibaAux: props.bultosEstiba 
                    })}>
                    <img style={loc} src={flagAux} />
                </a>
            </div>
        );
    }
    ...
    fechaVencimientoTemplate(props){
        ...
        return (
            <div>
            <span> {fechaVencimiento.split('T')[0]} </span>
            </div>
        );
    }
    ...
    dialogClosePdf(){
        this.setState({ hideDialogPdf: false });
    }
    ...
    buttonClickActualizar(){
        ...
        if(this.grid.getSelectedRecords().length === 0){
            ...
            if(this.grid.getSelectedRecords()[0].tieneExtencionFechaVencimiento){
                ...
                document.getElementById("fechavencimientompidactualizar").value = this.grid.getSelectedRecords()[0].fechaVencimiento.split(',').pop();
    ...
    headerPdf(){
        return (<div>  
            <span>ROTULACION DE MATERIA PRIMA</span>
        </div>);
    }
    ...
    footerTemplatePdf(){
        return (<div>                   
            <button id="sendButton" className="btn btn-info btn-block btn-lg" onClick={() => MpinputPdf()}>Imprimir Rotulacion M.P</button>
        </div>);
    }
        ...
        return (
            <div className="control-pane">
                    ...
                    {!Browser.isDevice ? (    
                        ...
                        >
                            ...
                            <ColumnDirective
                                ...
                                headerText="PDF"
                                width="250"
                                template={this.pdfMateriaPrima.bind(this)}
                            ></ColumnDirective>
                            </ColumnsDirective>
                            ...
                            <Inject services={[Filter, Sort, Edit, Toolbar, Page, Aggregate, Group, Selection]} />
                        </GridComponent>                  
                    ) : (
                    <GridComponent
                        id="adaptivedevice"
                ...
                <DialogComponent
                    ...
                    width="1000px"
                    beforeOpen={this.onBeforeOpen}
                    header={this.headerPdf.bind(this)}
        ...
        return(
            <div>    
                ...
                <div className="pdfImg"> 
                    <img src={BestImg} style={{ width: '50px', height: '50px' }} className="card-img-top mt-2" />
                </div>
                ...
                <div className='fEntradafVencimiento'>
                    ...
                    <div className='fechaVencimientoR'>
                        ...
                        <div className='fechaVencimientoRinput'>
                            {this.state.fechaVencimientoAux}
                        </div>
                    </div>
